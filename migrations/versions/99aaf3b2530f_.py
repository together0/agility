...
Revision ID: 99aaf3b2530f
Revises: 
Create Date: 2021-06-11 17:48:12.029944
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('first_trace_code', sa.String(length=34), nullable=False),
    sa.Column('name', sa.String(length=40), nullable=False),
    sa.Column('kind_name', sa.String(length=40), nullable=False),
    ...
    sa.Column('driver_id_number', sa.String(length=18), nullable=False),
    sa.Column('logistics_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['logistics_id'], ['logistics.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
